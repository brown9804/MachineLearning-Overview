...
# extensive use of it later in the course. As a first step, let's try to 
# understand the basics of this function. Using help(), figure out which of the 
# following input parameters are not optional for the np.random.choice() function:
...
### --------------------------------------------------------
# # ------>>>>> Queen and spade
#  Here event A is the card being a queen and event 
# B is the card being a spade. Think carefully about whether 
# the two events have anything in common.
# P(Queen) + P(Spade) - P(Queen of Spades)
# 4/52 + 13/52 - 1/52
# = 16/52
...
# function that you've already seen in the previous chapters.
#  You are given multiple variations of np.random.choice() 
# for sampling from arrays. Look at each variation carefully and 
# use the console to test out the options. Select the option that 
# could generate ['a', 'c', 'c'] as an output.
# R/np.random.choice(['a', 'b', 'c', 'd', 'e'], size=5, replace=True)[:3]
...
### --------------------------------------------------------
# # ------>>>>> Hypothesis testing - Non-standard statistics - Part#0
...
# In this exercise, you will refresh some basic concepts to test 
# your understanding of statistical power. It is very important to 
# understand statistical power, especially if you are designing an A/B test.

# Consider the following four options and select the factor that 
# does not influence the statistical power of an experiment:
