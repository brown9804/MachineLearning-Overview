...
##### ABOUT THAT
# Correct! Notice that you did not have to get the 
# best values, slope = 1 and intercept = 2, just something
#  close. Models almost NEVER match the data exactly, and a model 
# created from slightly different model parameters might 
# fit the data equally well. We'll cover quantifying model performance 
# and comparison in more detail later in this course!
...
best_data = data_sets['A']
 ...
 ### --------------------------------------------------------
# # ------>>>>> Terms in a Model Given a scatter plot of data,
#  select the linear model that 
# best fits the data. 
# To test your answer, use the predefined function plot_possible_answer(
# answer="X") to plot the answers, where X is one of the answers A-E.
# R/ y = 100 + 75x
...
# The formulae below are the result of working through the calculus
#  discussed in the introduction. In this exercise,
#   we'll trust that the calculus correct, and implement 
#   these formulae in code using numpy.
